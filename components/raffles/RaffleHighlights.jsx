...
const RaffleHighlights = () => {
  return (
    <div className="my-5 relative">
            <button className=" absolute z-40 top-1/2 right-2 translate-x-1/2 -translate-y-1/2 w-10 h-10 rounded-lg bg-jel-gray-3 hover:bg-jel-gray-2 flex items-center justify-center">
                <Image src={arrow} className="w-2"/>
            </button>
            <button className=" absolute z-40 top-1/2 left-2 -translate-x-1/2 -translate-y-1/2 w-10 h-10 rounded-lg bg-jel-gray-3 hover:bg-jel-gray-2 flex items-center justify-center">
                ...
                <div className="z-20 absolute w-full h-full bg-black/40 top-0 left-0 backdrop-blur-lg p-16 grid grid-cols-2 items-center justify-center gap-0">
                    ...
                    <div className="w-full">
                        ...
                        <div className="flex flex-row gap-3">
                            <button className="px-5 py-2 rounded-xl bg-black text-white font-semibold">Buy Ticket</button>
