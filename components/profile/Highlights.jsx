...
const Highlights = () => {
  ...
  return (
    <div className="border-[1px] overflow-hidden border-jel-gray-3 rounded-xl w-full h-80 relative flex items-center justify-center">
        ...
        <div onClick={()=>{setShowNftInfo(displayNFT[currentNft])}} className=" grid grid-cols-2 max-md:grid-cols-1 w-[60%]">
        <div className="h-80">
            <Image src={displayNFT[currentNft]?.img} width={1000} height={1000} className=' h-full object-contain'/>
        </div>
         <div  className="h-full flex flex-col items-start justify-center max-md:hidden">
