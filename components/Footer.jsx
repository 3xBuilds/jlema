...
const Footer = () => {
  return (
    <div>
        <div className="flex flex-row max-md:flex-col max-md:items-start max-md:justify-start max-sm:px-3 items-center justify-between px-10 border-t-[1px] border-jel-gray-3 py-5 mt-10">
